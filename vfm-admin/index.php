...
<body class="skin-<?php print $skin; ?> fixed sidebar-mini admin-body <?php echo $rtlclass; ?>"  data-target="#scrollspy" data-spy="scroll" data-offset="100">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="index.php?logout" title="<?php echo $setUp->getString("log_out"); ?>">
        ...
        <div class="content-wrapper">
            ...
            case 'appearance':
                if (GateKeeper::canSuperAdmin('superadmin_can_appearance')) { ?>
                    ...
                    <div class="content">
                        <form role="form" method="post" id="settings-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?section=appearance" enctype="multipart/form-data">
                        <?php
            ...
            default:
                ...
                <div class="content">
                    <form role="form" method="post" id="settings-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" enctype="multipart/form-data">
                        <?php
    ...
    <script type="text/javascript" src="admin-panel/js/admin.min.js?v=<?php echo $vfm_version; ?>"></script>
